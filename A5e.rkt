...
(check-expect (list->balanced (list 1 5 10)) (make-node (make-node empty empty 1) (make-node empty empty 10) 5))
(check-expect (list->balanced empty) empty)
...
(check-expect (list->balanced (list 10 12 15 16 17 20)) (make-node
 (make-node
  '()
  (make-node '() '() 12)
  10)
 (make-node
  ...
  17)
 15))
(check-expect (list->balanced (list 10 11 12 13 14)) (make-node
 (make-node
  '()
  (make-node '() '() 11)
  10)
