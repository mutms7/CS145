...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname A5g) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (rand->balanced (list 1 5 10)) (make-node (make-node empty empty 1) (make-node empty empty 10) 5))
...
(check-expect (rand->balanced (list 10 12 15 16 17 20)) (make-node
 (make-node
  '()
  (make-node '() '() 12)
  10)
